...
class EployeeViewScreen extends StatefulWidget {
  const EployeeViewScreen({super.key});

  @override
  State<EployeeViewScreen> createState() => _EmployeeViewScreenState();
}

class _EmployeeViewScreenState extends State<EployeeViewScreen> {
